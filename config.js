...
const CARDS = {
    ...
    // Amber — pacifist fire-walker. Costs 9 (high — she's invulnerable
    // and her trail is permanent until 5s after she dies). HP 700,
    ...
    'amber': { name: 'אמבר', cost: 9, type: 'unit', color: '#e67e22', icon: '🔥' }
};
