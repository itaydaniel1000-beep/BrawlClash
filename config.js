...
const STAR_POWERS = {
    ...
    'bubble': [
        ...
        { id: 'sp2', name: 'מסטיק מתפצל', desc: 'אחרי האויב הראשון, הבועה מתפצלת ל-2 בועות קטנות שעושות 60 נזק כל אחת ועוברות 6 צעדים' }
    ],
    'trunk': [
    ...
    'gray': [
        ...
        { id: 'sp2', name: 'פורטל שלישי', desc: 'אויב שדורך על פורטל לא משתגר אבל מקבל 500 נזק' }
    ],
    'pang': [
    ...
    'raps': [
        { id: 'sp1', name: 'פצצה תשיעית', desc: 'פצצה תשיעית במרכז האשכול שעושה 1000 נזק' },
        { id: 'sp2', name: 'פצצה מועצמת', desc: 'כל פצצה עושה 750 נזק במקום 500' }
    ],
    'willow': [
