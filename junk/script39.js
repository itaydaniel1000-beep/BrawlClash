...
let releaseBtnEl = document.getElementById('release-freeze-btn');
if (releaseBtnEl) {
    releaseBtnEl.addEventListener('click', (e) => {
        e.stopPropagation();
