...
function buildDeck() {
    deckContainer.innerHTML = `
        <div class="deck-section" id="deck-left"></div>
        <div class="deck-section" id="deck-center"></div>
        <div class="deck-section" id="deck-right"></div>
    `;
    ...
    for(let i=0; i<keys.length; i++) {
        ...
        if (card.type === 'aura') {
            document.getElementById('deck-left').appendChild(d);
        } else if (card.type === 'building') {
            document.getElementById('deck-right').appendChild(d);
        } else {
            document.getElementById('deck-center').appendChild(d);
        }
    }
}
