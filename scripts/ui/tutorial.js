...
(function () {
    ...
    const ALL_BRAWLERS = ['bruce', 'leon', 'bull', 'amber', 'bubble', 'sirius', 'trunk',
    ...
    const BRAWLER_TIPS = {
        ...
        bubble:   'באבל — בועת מסטיק שעולה רק 3 אליקסיר. אף אחד לא רואה אותה. לחץ והחזק על המפה, מתח לכיוון שאתה רוצה ושחרר — היא תיורה כמו קלע במהירות פי 6 (מהירה), נחבטת בקירות ומחזירה 90°, ועושה 100 נזק לכל אויב שעוברת עליו. מקסימום 36 צעדים.',
