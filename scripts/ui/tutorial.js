...
(function () {
    ...
    const ALL_BRAWLERS = ['bruce', 'leon', 'bull', 'amber', 'golem',
    ...
    const BRAWLER_TIPS = {
        ...
        golem:    'גולם מגמה — טנק כבד מאוד עם 2200 חיים ונזק 250. איטי (מהירות 30) אבל סופג עוד ועוד מכות. מצוין לקו הגנה ראשון כך שדמויות מהירות אחרות שלך יוכלו לעבור מאחוריו. עולה 8 אליקסיר.'
    };
