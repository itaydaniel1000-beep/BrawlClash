...
(function () {
    ...
    const BRAWLER_TIPS = {
        ...
        bubble:   'באבל — בועת מסטיק שעולה רק 3 אליקסיר. אף אחד לא רואה אותה. לחץ והחזק על המפה, מתח לכיוון שאתה רוצה ושחרר — היא תיורה כמו קלע במהירות פי 3, נחבטת בקירות ומחזירה 90°, ועושה 100 נזק לכל אויב שעוברת עליו. מקסימום 18 צעדים.'
    };
