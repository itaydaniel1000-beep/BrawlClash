...
const GUIDE_CHAR_ROLES = {
    ...
    'golem':   { role: 'יחידה — טנק כבד', base: '2200 HP / 250 DMG, מהירות 30', blurb: 'גולם מגמה איטי אבל טנקי. עולה 8 אליקסיר. סופג מכות כמו ספוג ומחזיר נזק כבד מטווח קרוב. שילוב מנצח: הניחו אותו ראשון כקו הגנה ואחריו דמויות מהירות שיתפסו את היריבים שעוברים אותו.' }
};
