...
const GUIDE_CHAR_ROLES = {
    ...
    'bubble':  { role: 'יחידה — בועת מסטיק', base: '100 HP / 100 DMG מגע, מהירות ×3', blurb: 'באבל היא בועת מסטיק שעולה רק 3 אליקסיר. **אף דמות לא רואה אותה** — לא יורים בה, לא תוקפים, לא רודפים אחריה. כדי לשלוח אותה: **לחיצה ארוכה על המפה ומתיחה לכיוון** — היא תיורה כמו קלע באותו כיוון במהירות פי 3 מדמות רגילה. כל אויב שהיא עוברת עליו מקבל 100 נזק חד-פעמי. מתנגשת בקיר → קופצת 90° לכיוון הנגדי. נכבית אחרי 18 צעדים.' }
};
